...
def process_csv():
    ...
    """
    df = pd.read_csv(os.path.join(config['data'], 'RM8_a7d186_4_power.csv'), sep=',', parse_dates=[DATETIME])
    ...
    df.to_csv(os.path.join(config['data'], 'RM8_a7d186_4_power_synth.csv'), index=False)
...
def load_raw_dataset():
    ...
    """
    df = pd.read_csv(os.path.join(config['data'], 'RM8_a7d186_4_power.csv'), sep=';')
    return df
...
def load_dataset(fill_nan='median', get_dates_dict=False):
    ...
    """
    df = pd.read_csv(os.path.join(config['data'], 'RM8_a7d186_4_power_synth.csv'))
